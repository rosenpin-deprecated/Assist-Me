...
public class PreferencesSeekBar extends Preference implements OnSeekBarChangeListener {
    ...
    public PreferencesSeekBar(Context context, AttributeSet attrs, int defStyle) {
