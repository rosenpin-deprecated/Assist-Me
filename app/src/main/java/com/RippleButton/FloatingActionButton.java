...
public class FloatingActionButton extends View {
    ...
    public void init(int FloatingActionButtonColor) {
        ...
        mButtonPaint.setColor(getResources().getColor(R.color.materialBlue));
    ...
    public void showFloatingActionButton() {
        if (mHidden) {
            ...
            animSetXY.setDuration(animTime);
            animSetXY.start();
            mHidden = false;
